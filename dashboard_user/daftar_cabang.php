...
<div class="container-fluid">
    <div class="row" >
        ...
        <div class="col-md-2 pt-5" style="background-color: #db881a; color: white;">
            ...
            <div class="row">
                <a class="nav-link ms-3" href="../dashboard_user/profil_user.php"><p style="text-indent: 0;"><i class="bi bi-buildings me-2"></i>Daftar Cabang</p></a>
            </div>
        ...
        <div class="col-md-10 bg-body-tertiary py-3">
            ...
            <div class="container mt-3 rounded-4 shadow py-3 my-5" style="background-color: white;">
                <div class="row">
                    <div class="col-6">
